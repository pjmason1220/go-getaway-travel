...
export default function Header() {
  ...
  const navigation = [
    { name: 'Home', href: '/' },
    { name: 'Shady Lake Hideaway', href: '/properties/shady-lake-hideaway' },
    { name: 'Sunset Ridge', href: '/properties/sunset-ridge' },
            ...
            <div className="flex flex-col space-y-4">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="text-neutral-600 hover:text-primary-600 font-medium transition-colors px-2 py-1"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 text-neutral-600 hover:text-pink-600 transition-colors px-2 py-1"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
