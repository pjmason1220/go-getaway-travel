      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          >
            ...
            <span className="text-lg font-semibold">@go_getaway</span>
          </a>
          <h2 className="text-3xl md:text-4xl font-display font-bold text-neutral-900 mt-3">
            Follow Our Adventures
          </h2>
          <p className="text-neutral-600 mt-2 max-w-2xl mx-auto">
            See the latest from our properties and get inspired for your next Lake Cumberland getaway.
          </p>
        </div>
